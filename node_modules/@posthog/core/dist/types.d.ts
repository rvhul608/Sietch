...
export declare const SurveyQuestionDescriptionContentType: {
    readonly Html: "html";
    readonly Text: "text";
};
export type SurveyQuestionDescriptionContentType = (typeof SurveyQuestionDescriptionContentType)[keyof typeof SurveyQuestionDescriptionContentType];
export declare const SurveyValidationType: {
...
export declare const SurveyRatingDisplay: {
...
export declare const ActionStepStringMatching: {
