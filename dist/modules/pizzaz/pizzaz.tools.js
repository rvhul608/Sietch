...
let PizzazTools = class PizzazTools {
    pizzazService;
    constructor(pizzazService) {
        this.pizzazService = pizzazService;
    }
    async showPizzaMap(args, ctx) {
        let shops;
        switch (args.filter) {
            case 'open_now':
...
], PizzazTools.prototype, "showPizzaMap", null);
__decorate([
    Tool({
    ...
    __metadata("design:paramtypes", [void 0, Object]),
    __metadata("design:returntype", Promise)
], PizzazTools.prototype, "showPizzaList", null);
__decorate([
    Tool({
    ...
    __metadata("design:paramtypes", [void 0, Object]),
    __metadata("design:returntype", Promise)
], PizzazTools.prototype, "showPizzaShop", null);
PizzazTools = __decorate([
    Injectable({ deps: [PizzazService] }),
    __metadata("design:paramtypes", [PizzazService])
], PizzazTools);
export { PizzazTools };
//# sourceMappingURL=pizzaz.tools.js.map